...
plugins=(git vagrant colored-man-pages zsh-navigation-tools fzf autojump)
...
alias grep='ag'
alias c='clear'
alias getgit='git remote show origin'
alias h='history|fzf'
alias getgigs='du -h --max-depth=1|grep "[0-9]*[0-9]G"'
alias startbluetooth='sudo systemctl start bluetooth && sudo bluetoothctl'
